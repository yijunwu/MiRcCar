...
public class BleDeviceManager {
    ...
    public void init(Context context) {
        ...
        ViseBle.config().setScanTimeout(3000).setScanRepeatInterval(BleConstant.DEFAULT_CONN_TIME).setConnectTimeout(PathInterpolatorCompat.MAX_NUM_POINTS).setOperateTimeout(BleConstant.DEFAULT_OPERATE_TIME).setConnectRetryCount(1).setConnectRetryInterval(1000).setOperateRetryCount(2).setOperateRetryInterval(1000).setMaxConnectCount(3);
